...
import {QUIZ} from "../data/dummyData"

const QuizScreen=(props)=>{

const renderQuiz = (itemData)=>{
    ...
    return(
        ...
        source={{uri: ("https://i.pinimg.com/736x/65/9a/2b/659a2bc335f31700cacba5e1f2556b1f.jpg")}}>
         <View style={styles.logoview}>
          ...
          <Text style={styles.welcome}>Your QUIZZES</Text>
          </View>
        <FlatList  keyExtractor={(item,index)=> item.id} numColumns={1} data={QUIZ} renderItem={renderQuiz}/>
